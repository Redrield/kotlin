...
public inline class UShort internal constructor(private val data: Short) : Comparable<UShort> {
    ...
    public infix operator fun and(other: UShort): UShort = UShort(this.data and other.data)
    /** Performs a bitwise OR operation between the two values. */
    public infix operator fun or(other: UShort): UShort = UShort(this.data or other.data)
    /** Performs a bitwise XOR operation between the two values. */
    public infix operator fun xor(other: UShort): UShort = UShort(this.data xor other.data)
