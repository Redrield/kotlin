...
public inline class UByte internal constructor(private val data: Byte) : Comparable<UByte> {
    ...
    public infix operator fun and(other: UByte): UByte = UByte(this.data and other.data)
    /** Performs a bitwise OR operation between the two values. */
    public infix operator fun or(other: UByte): UByte = UByte(this.data or other.data)
    /** Performs a bitwise XOR operation between the two values. */
    public infix operator fun xor(other: UByte): UByte = UByte(this.data xor other.data)
